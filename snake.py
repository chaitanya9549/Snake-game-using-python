...
pygame.display.set_caption('Snake Game by Chaitanya')
...
def gameLoop():#main game method
    game_over = False#initialising game_over as false
    game_close = False
